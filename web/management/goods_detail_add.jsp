...
<head>
    <meta charset="UTF-8">
    <title>添加商品详细信息</title>
    <link href="../management-css/detail_add.css" rel="stylesheet" type="text/css">
    ...
    <script>
        var a =<%=session.getAttribute("info_addGoods")%>
        <%session.removeAttribute("info_addGoods");%>
        if (a == "000") {
            alert("添加成功!");
...
<main>
    ...
    <div class="main_top_left">
        你现在的位置：<a href="../home/index.jsp">OrangeLaLa</a>>商品详细管理系统
    </div>
    <!--中左表格-->
    <div class="main_left">
        <ul>
    ...
    <div class="main_center_left">
        <p><img src="../management-css/images/ai.png"><strong>添加商品详细信息</strong></p>
        <hr class="line">
        <form action="goodsadd.do" method="post" enctype="multipart/form-data">
            <table class="main-right-footer">
                <tr>
                    <td class="main-right-footer-1">商品名称:</td>
                    <td><input type="text" size="50" name="name"></td>
                </tr>
                <tr>
                    <td class="main-right-footer-1">商品介绍:</td>
                    <td><input type="text" size="50" name="descr"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="equiv" size="50"></td>
                </tr>
                <tr>
