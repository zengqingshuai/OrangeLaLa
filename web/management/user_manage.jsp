...
<head>
    ...
    <link href="../management-css/user_manage.css" rel="stylesheet" type="text/css">
...
<main>
    ...
    <div class="main_top_left">
        你现在的位置：<a href="../home/index.jsp">OrangeLaLa</a>>用户管理系统
    </div>
    <!--中左表格-->
    <div class="main_left">
        <ul>
    ...
    <div class="main_center_left">
        <p><img src="../management-css/images/ai.png"><strong>用户管理</strong></p>
        <hr class="line">
            ...
            <table>
                ...
                <%
                   MysqlUtil2 mu = new MysqlUtil2();
                    ...
                    if(id!=null){
                       mu.update("update oll_user set status= 0 where id = "+Integer.parseInt(id));
                   }
                    if (acc!=null){
                       mu.update("update oll_user set status= 1 where account='"+acc+"'");
                   }
                   int currpage=request.getParameter("p")==null?1: Integer.parseInt(request.getParameter("p"));
                   mu.setCurrpage(currpage);
                    List<Map<String,Object>>list =mu.page("oll_user","id,account,status","where 1=1","");
                ...
                <tr>
                    ...
                    %>
                    <td><%=status%></td>
                    <td><img src="../management-css/images/dongjie.png"><a href="?id=<%=m.get("id")%>&p=<%=mu.getCurrpage()%>">冻结</a>
                        <img src="../management-css/images/jiedong.png"><a href="?name=<%=m.get("account")%>&p=<%=mu.getCurrpage()%>">解冻</a>
                    </td>
                </tr>
                <%}%>
                <tr>
