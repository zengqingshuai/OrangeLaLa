...
<head>
    ...
    <link href="../management-css/goods_detail_manage.css" rel="stylesheet" type="text/css">
...
<main>
    ...
    <div class="main_center_left">
        <p><img src="../management-css/images/ai.png"><strong>商品详细信息管理</strong></p>
        <hr class="line">
        <div class="main_center_right">
            <table>
                <tr>
                    <th class="main_center_right_th1">商品编号</th>
                    <th>商品名称</th>
                    <th>二级分类</th>
                    <th class="main_center_right_th2">价格</th>
                    <th class="main_center_right_th2">库存</th>
                    <th>图片</th>
                    <th class="main_center_right_th2">操作</th>
                </tr>
                <%
                    MysqlUtil2 mu = new MysqlUtil2();
                    String id = request.getParameter("id");
                    if (id != null) {
                        mu.delete("oll_goods", "where id = '" + id + "'");
                    }
                    mu.setPagesize(5);
                    int currpage = request.getParameter("p") == null ? 1 : Integer.parseInt(request.getParameter("p"));
                    mu.setCurrpage(currpage);
                    List<Map<String, Object>> list = mu.page("oll_goods a,oll_type2 b","a.id,goodsname,name,price,store,picname"," where a.t2id=b.id", "");
                ...
                <tr>
                    ...
                    <td><img style="width: 90px;height: 90px;" src="../images/<%=m.get("picname")%>"></td>
                    <td class="table1"><img src="../management-css/images/b1.png"><a href="goods_detail_modify.jsp?modifygoods=<%=m.get("goodsname")%>">修改</a>
