...
<head>
    ...
    <link href="../management-css/category_manage.css" rel="stylesheet" type="text/css">
...
<main>
    ...
    <div class="main_center_left">
        <p><img src="../management-css/images/ai.png"><strong>管理二级分类</strong></p>
        <hr class="line">
        <div class="main_center_right">
            <table>
                ...
                <%
                    ...
                    if (id != null) {
                        mu.delete("oll_type2", "where id='" + id + "'");
                    }
                    mu.setPagesize(10);
                    int currpage = request.getParameter("p") == null ? 1 : Integer.parseInt(request.getParameter("p"));
                    mu.setCurrpage(currpage);
                    List<Map<String, Object>> l = mu.page("oll_type2 b,oll_type1 a", "b.id,b.name as bname,a.name as aname", "where b.t1id=a.id", "");
                ...
                <tr>
                    ...
                    <td><img src="../management-css/images/b1.png"><a href="category_modify.jsp?twotype=<%=m.get("bname")%>&twoty=<%=m.get("aname")%>">修改</a>
