...
<head>
    ...
    <link href="../management-css/class_manage.css" rel="stylesheet" type="text/css">
...
<main>
    ...
    <div class="main_top_left">
        你现在的位置：<a href="../home/index.jsp">OrangeLaLa</a>>商品分类管理
    </div>
    <!--中左表格-->
    <div class="main_left">
        <ul>
    ...
    <div class="main_center_left">
        <p><img src="../management-css/images/ai.png"><strong>一级分类管理</strong></p>
        <hr class="line">
        <div class="main_center_right">
            <table>
                ...
                <tr>
                    ...
                    <td class="table1"><img src="../management-css/images/b1.png"><a href="class_modify.jsp?onetype=<%=m.get("name")%>">修改</a>
