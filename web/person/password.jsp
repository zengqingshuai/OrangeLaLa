...
<html>
	...
	<head>
		...
		<script>
			var a='<%=request.getParameter("info")%>';
			if (a!="null"){
			    if (a=="ok"){
			        alert("修改成功")
				}else if (a=="no"){
					...
					<div class="am-container header">
						...
						<ul class="message-r">
							...
							<div class="topMessage mini-cart">
								<div class="menu-hd"><a id="mc-menu-hd" href="../home/index.jsp" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
							</div>
		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<form class="am-form am-form-horizontal" action="person_updata_pass.do" method="post" >
						<div class="am-form-group">
							<label for="user-old-password" class="am-form-label">账户名</label>
							<div class="am-form-content">
								<input type="password" id="user-old-password" name="old_pass" placeholder="请输入原登录账号">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">新密码</label>
							<div class="am-form-content">
								<input type="password" id="user-new-password" name="new_pass" placeholder="由数字、字母组合">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">确认密码</label>
							<div class="am-form-content">
								<input type="password" id="user-confirm-password" name="new_pass_2" placeholder="请再次输入上面的密码">
							</div>
						</div>
						<div class="info-btn">
							<input type="submit" value="保存修改" style="border: 0; font-size: 16px; height:30px; width:100px;background-color: rgba(240,0,0,0.93) ;color: white">
						</div>
